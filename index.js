...
exports.reduceUI = (state, { type, config }) => {
  ...
  const lightTheme = {
    backgroundColor: config.enableVibrancy ? "transparent" : "#fafafa",
    ...
    colors: {
      ...
      lightMagenta: "#a626a4",
      lightCyan: "#0184bc",
      lightWhite: config.enableVibrancy ? "transparent" : "#fafafa",
    },
    css: `
    .header_header {
      top: 0;
  ...
  let theme = require("@electron/remote").nativeTheme.shouldUseDarkColors
    ? darkTheme
    : lightTheme;
